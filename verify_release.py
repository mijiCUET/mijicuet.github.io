...
check(all(x in s for x in ['id="headerHomeBtn"','id="headerLoginBtn"','id="headerCreateBtn"','id="accountStatus"','id="headerLogoutBtn"']),'Home/Login/Create-account/username/Logout header controls are present')
...
check('await revokeLocalSession();' in s and 'prepareLogin(kind);' in s,'Practice/Test entry forces the login flow')
